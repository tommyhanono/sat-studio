  ...
  questions: [
    {
      ...
      choices:{
        A:'Coral reefs are found only in a small part of the ocean floor.',
        B:'Sea turtles and crabs are the animals most dependent on coral reefs.',
        C:'Coral reefs are the most colorful habitats in the entire ocean.',
    ...
    },
    {
      ...
      choices:{
        A:'To describe the kinds of festivals once held at the ancient city.',
    ...
    },
    {
      ...
      choices:{
        ...
        B:'Patrons dislike reading any book that has a worn cover.',
        C:'The library owns more worn books than pristine ones.',
    ...
    },
    {
      ...
      stem:'Which choice best states the main idea of the text?',
      choices:{
        A:'Clara Wieck Schumann was the greatest pianist Europe ever produced.',
        ...
        C:'Scholars in the past refused to listen to any music written by women.',
    ...
    },
    {
      ...
      stem:'Which choice best states the main idea of the text?',
      choices:{
        A:'Underwater volcanic eruptions are more common than eruptions on land.',
        B:'Satellites are the only way to study what happens in the open ocean.',
    ...
    },
    {
      ...
      stem:'Which choice best states the main idea of the text?',
      choices:{
        A:'The narrator plans to restore the garden to its former beauty.',
        B:'The story explains the proper way to care for an overgrown garden.',
        C:'The grandmother was the best gardener in the entire town.',
    ...
    },
    {
      ...
      stem:'Which choice best states the main idea of the text?',
      choices:{
        A:'Infants cannot learn language until they are taught grammar in school.',
        B:'Rather than simply imitating speech, children appear to build their language’s rules on their own.',
        C:'Adults speak in sentences that children can easily memorize word for word.',
    ...
    },
    {
      ...
      choices:{
        ...
        C:'volunteers never enjoy any task performed in complete silence.',
    ...
    },
    {
      ...
      choices:{
        A:'The vine failed completely and never stabilized the hillsides at all.',
        B:'Native trees and shrubs are weaker than the invasive vine in every way.',
