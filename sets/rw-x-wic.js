...
window.SAT_SETS.push({
  ...
  section: "rw",
  level: "Extreme",
  description: "Hard-Module-2 level: second meanings, double contrasts, and dense academic prose.",
  minutes: 16,
  questions: [
    {
      id:"XW-01", type:"mc", domain:"Craft and Structure", skill:"Words in Context",
      difficulty:"Difícil", extreme:true,
      passage:"By the time the estate was settled, the modest coastal lot the family had bought decades earlier for almost nothing had come to %BLANK% so dramatically that its sale alone covered every outstanding debt several times over.",
    ...
    },
    {
      ...
      difficulty:"Difícil", extreme:true,
      passage:"Reviewers praised the biography as exhaustive, yet one specialist found it curiously %BLANK% in exactly the area readers cared about most: on the subject’s decisive final decade, the book offers barely a dozen thinly sourced pages.",
      stem:"Which choice completes the text with the most logical and precise word or phrase?",
    ...
    },
    {
      ...
      difficulty:"Difícil", extreme:true,
      passage:"Engineers redesigning the plant were struck less by its raw output than by its %BLANK%: it delivered the same tonnage as rival mills while drawing a fraction of the water and power, wasting almost nothing along the way.",
      stem:"Which choice completes the text with the most logical and precise word or phrase?",
    ...
    },
    {
      ...
      difficulty:"Difícil", extreme:true,
      passage:"The committee’s endorsement of the proposal was real but conspicuously %BLANK%: every paragraph of approval was trailed by a caveat, and the final vote bound the plan to so many conditions that its backers hardly recognized it.",
      stem:"Which choice completes the text with the most logical and precise word or phrase?",
    ...
    },
    {
      ...
      difficulty:"Difícil", extreme:true,
      passage:"Although rivals dismissed Okonkwo’s framework as hopelessly %BLANK%, its forecasts, unlike the elaborate constructions of the leading schools, kept turning out to be right: a spare handful of assumptions consistently outpredicted models bristling with variables.",
      stem:"Which choice completes the text with the most logical and precise word or phrase?",
    ...
    },
    {
      ...
      difficulty:"Difícil", extreme:true,
      passage:"Where her earlier canvases had been almost oppressively %BLANK%—every inch crowded with incident—the late works achieve their power through restraint, letting a single gesture carry an entire wall.",
      stem:"Which choice completes the text with the most logical and precise word or phrase?",
    ...
    },
    {
      ...
      difficulty:"Difícil", extreme:true,
      passage:"Though contemporaries denounced the pamphlet as %BLANK%, later historians noted that, unlike the cautious tracts surrounding it, it merely stated openly what everyone already privately believed—hardly a fabrication, simply an indiscretion.",
      stem:"Which choice completes the text with the most logical and precise word or phrase?",
    ...
    },
    {
      ...
      difficulty:"Difícil", extreme:true,
      passage:"Critics expecting the sequel to feel %BLANK% were surprised: rather than merely reworking the first film’s tricks, as most follow-ups do, it took the premise somewhere genuinely unforeseen, extending the story instead of echoing it.",
      stem:"Which choice completes the text with the most logical and precise word or phrase?",
    ...
    },
    {
      ...
      difficulty:"Difícil", extreme:true,
      passage:"For the revisionist school, the archive is never a neutral deposit of facts but a %BLANK% one: its very silences and inclusions encode the priorities of those who assembled it, so that to read it is already to inherit their judgments.",
      stem:"Which choice completes the text with the most logical and precise word or phrase?",
    ...
    },
    {
      ...
      difficulty:"Difícil", extreme:true,
      passage:"The philosopher’s prose exerts a peculiar authority precisely because it is so %BLANK%: it advances no thesis it has not already hedged, qualifies each claim before an objection can be raised, and leaves the reader with the impression of a mind that has anticipated every possible dissent.",
      stem:"Which choice completes the text with the most logical and precise word or phrase?",
    ...
    },
    {
      ...
      difficulty:"Difícil", extreme:true,
      passage:"What distinguishes the theory is not its novelty but its %BLANK%: it absorbs anomalies that would have shattered a lesser account, bending to accommodate each new finding without ever losing its essential shape.",
      stem:"Which choice completes the text with the most logical and precise word or phrase?",
    ...
    },
    {
      ...
      difficulty:"Difícil", extreme:true,
      passage:"The monograph’s influence has proved oddly %BLANK%: rarely cited and long out of print, it nonetheless shaped a generation of scholars who absorbed its assumptions so thoroughly that they no longer recognized them as arguable at all.",
      stem:"Which choice completes the text with the most logical and precise word or phrase?",
