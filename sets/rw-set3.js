...
window.SAT_SETS.push({
  ...
  questions: [
    {
      id:'WIC-E-01', type:'mc', domain:'Craft and Structure', difficulty:'Fácil',
      skill:'Words in Context',
      passage:"Many people think honeybees are the only insects that pollinate crops. In fact, that idea is %BLANK% wild bees, beetles, and even some flies also carry pollen from flower to flower, helping farms produce food.",
    ...
    },
    {
      ...
      skill:'Words in Context',
      passage:"The city library used to close at 6 p.m., which left many students with no place to study at night. To %BLANK% this problem, the council voted to keep the building open until midnight during exam weeks.",
      stem:'Which choice completes the text with the most logical and precise word or phrase?',
    ...
    },
    {
      ...
      skill:'Words in Context',
      passage:"At first the coach doubted that the new player was fast. During the tryout, however, she sprinted past every runner on the field, leaving no %BLANK% about her remarkable speed.",
      stem:'Which choice completes the text with the most logical and precise word or phrase?',
    ...
    },
    {
      ...
      skill:'Words in Context',
      passage:"The instructions for the model airplane were very %BLANK% each step was numbered, drawn in detail, and written in plain language, so even a first-time builder could follow along without help.",
      stem:'Which choice completes the text with the most logical and precise word or phrase?',
    ...
    },
    {
      ...
      skill:'Words in Context',
      passage:"Unlike her older sister, who spends money the moment she earns it, Diana is remarkably %BLANK% she saves most of her paycheck and rarely buys anything she does not truly need.",
      stem:'Which choice completes the text with the most logical and precise word or phrase?',
    ...
    },
    {
      ...
      skill:'Words in Context',
      passage:"The scientist did not accept the results after a single test. Instead, she repeated the experiment dozens of times to %BLANK% that the outcome was reliable and not just a lucky accident.",
      stem:'Which choice completes the text with the most logical and precise word or phrase?',
    ...
    },
    {
      ...
      skill:'Words in Context',
      passage:"The old bridge had grown so %BLANK% that engineers closed it to traffic. Rust had eaten through its beams, and large cracks ran along the concrete, making it unsafe for even a single car to cross.",
      stem:'Which choice completes the text with the most logical and precise word or phrase?',
    ...
    },
    {
      ...
      skill:'Words in Context',
      passage:"When the teacher asked who had left the classroom a mess, no one spoke. The long %BLANK% grew uncomfortable until, at last, one student quietly admitted that he had knocked over the paint.",
      stem:'Which choice completes the text with the most logical and precise word or phrase?',
    ...
    },
    {
      ...
      skill:'Words in Context',
      passage:"The documentary was praised for being %BLANK% it did not favor either side of the debate. The filmmakers gave equal time to both political parties and let viewers reach their own conclusions.",
      stem:'Which choice completes the text with the most logical and precise word or phrase?',
    ...
    },
    {
      ...
      skill:'Words in Context',
      passage:"Learning to play the violin takes years of daily effort. A student who practices for only a week and then quits will make little progress; real skill requires steady %BLANK% over a long time.",
      stem:'Which choice completes the text with the most logical and precise word or phrase?',
