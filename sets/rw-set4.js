...
window.SAT_SETS.push({
  ...
  questions: [
    {
      id:'WIC-H-01', type:'mc', domain:'Craft and Structure', difficulty:'Difícil',
      skill:'Words in Context',
      passage:"Historians once treated the medieval guild as a purely economic body, but recent scholarship has shown its role to be far more %BLANK%: the same institution that fixed prices and regulated apprenticeships also staged religious pageants, funded almshouses, and adjudicated disputes among its members.",
    ...
    },
    {
      ...
      skill:'Words in Context',
      passage:"Although the young naturalist’s field notebooks brim with vivid observations, his published monograph is oddly %BLANK%: he strips away the color and detail of his notes, reducing weeks of watching a single tide pool to a few clipped, impersonal sentences.",
      stem:'Which choice completes the text with the most logical and precise word or phrase?',
    ...
    },
    {
      ...
      skill:'Words in Context',
      passage:"Far from settling the question, the new fossil only %BLANK% the debate over bird origins: each camp read the specimen’s ambiguous wrist bones as vindication, and within months the disagreement had grown sharper and more entrenched than before.",
      stem:'Which choice completes the text with the most logical and precise word or phrase?',
    ...
    },
    {
      ...
      skill:'Words in Context',
      passage:"The essayist is admired less for the originality of her ideas than for her %BLANK%: she can compress a tangled philosophical argument into a single, luminous sentence that a general reader grasps at once.",
      stem:'Which choice completes the text with the most logical and precise word or phrase?',
    ...
    },
    {
      ...
      skill:'Words in Context',
      passage:"Rather than rejecting folk remedies outright, the pharmacologist adopted a %BLANK% stance: she catalogued hundreds of traditional plant cures, tested each in the laboratory, and endorsed only the handful that survived rigorous scrutiny.",
      stem:'Which choice completes the text with the most logical and precise word or phrase?',
    ...
    },
    {
      ...
      skill:'Words in Context',
      passage:"Diplomatic memoirs of the era are notoriously %BLANK%: their authors, still bound by loyalties and unsettled scores, tend to burnish their own judgment and quietly omit the miscalculations that a later, disinterested archive lays bare.",
      stem:'Which choice completes the text with the most logical and precise word or phrase?',
    ...
    },
    {
      ...
      skill:'Words in Context',
      passage:"The committee praised the proposal’s ambition but faulted its %BLANK% budget: revenue was projected with airy optimism, whole categories of cost went unmentioned, and the final figures rested on assumptions no one had bothered to verify.",
      stem:'Which choice completes the text with the most logical and precise word or phrase?',
    ...
    },
    {
      ...
      skill:'Words in Context',
      passage:"Unlike the flood of imitators who chased its success, the original film has proven remarkably %BLANK%: forty years on, its images still unsettle audiences, while the copies that once crowded theaters have been entirely forgotten.",
      stem:'Which choice completes the text with the most logical and precise word or phrase?',
    ...
    },
    {
      ...
      skill:'Words in Context',
      passage:"The senator’s apology was widely dismissed as %BLANK%: delivered in a flat monotone, hedged with lawyerly qualifications, and offered only after every attempt to bury the story had failed, it convinced almost no one of genuine remorse.",
      stem:'Which choice completes the text with the most logical and precise word or phrase?',
    ...
    },
    {
      ...
      skill:'Words in Context',
      passage:"What makes the theory so difficult to test is its %BLANK%: framed so loosely that almost any outcome can be read as confirmation, it never risks the kind of sharp, falsifiable prediction that would allow an experiment to prove it wrong.",
      stem:'Which choice completes the text with the most logical and precise word or phrase?',
