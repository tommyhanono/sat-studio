...
window.SAT_SETS.push({
  ...
  questions: [
    {
      id:'RHF-01', type:'mc', domain:'Expression of Ideas', difficulty:'Fácil',
      skill:'Rhetorical Synthesis',
      passage:"",
      stem:"While researching a topic, a student has taken the following notes:<ul><li>The axolotl is a type of salamander.</li><li>It lives in lakes near Mexico City.</li><li>It can regrow lost body parts, such as legs.</li></ul>The student wants to emphasize a special ability of the axolotl. Which choice most effectively uses relevant information from the notes to accomplish this goal?",
      choices:{
        A:'The axolotl is a type of salamander.',
        B:'The axolotl lives in lakes near Mexico City.',
        C:'The axolotl can regrow lost body parts, such as its legs.',
    ...
    },
    {
      ...
      skill:'Rhetorical Synthesis',
      passage:"",
      stem:"While researching a topic, a student has taken the following notes:<ul><li>The kalimba is a small musical instrument from Africa.</li><li>It has metal tines, or thin keys.</li><li>Players press the tines with their thumbs.</li><li>It is sometimes called a \"thumb piano.\"</li></ul>The student wants to introduce the kalimba to readers who have never heard of it. Which choice most effectively uses relevant information from the notes to accomplish this goal?",
      choices:{
        A:'Players press the tines of the kalimba with their thumbs.',
        B:'The kalimba is a small musical instrument from Africa with thin metal keys called tines.',
        C:'The kalimba is sometimes called a "thumb piano."',
    ...
    },
    {
      ...
      skill:'Rhetorical Synthesis',
      passage:"",
      stem:"While researching a topic, a student has taken the following notes:<ul><li>A team tested two paper airplane designs.</li><li>Design A flew an average of 6 meters.</li><li>Design B flew an average of 11 meters.</li></ul>The student wants to present the specific result of the test. Which choice most effectively uses relevant information from the notes to accomplish this goal?",
      choices:{
        A:'Design A flew an average of 6 meters, while Design B flew an average of 11 meters.',
        B:'Paper airplane designs can affect how far a plane flies.',
        C:'A team tested two different paper airplane designs.',
    ...
    },
    {
      ...
      skill:'Rhetorical Synthesis',
      passage:"",
      stem:"While researching a topic, a student has taken the following notes:<ul><li>A community started a rooftop garden.</li><li>The garden had no shade for the plants.</li><li>The hot sun dried out the soil.</li><li>Many of the young plants died.</li></ul>The student wants to explain why the young plants died. Which choice most effectively uses relevant information from the notes to accomplish this goal?",
      choices:{
        A:'With no shade, the hot sun dried out the soil, so many of the young plants died.',
        B:'A community decided to start a rooftop garden.',
        C:'Many of the young plants in the rooftop garden did not survive.',
    ...
    },
    {
      ...
      skill:'Rhetorical Synthesis',
      passage:"",
      stem:"While researching a topic, a student has taken the following notes:<ul><li>Honey never spoils if it is sealed.</li><li>Honey is very low in water.</li><li>It is also very acidic.</li><li>Bacteria cannot grow in these conditions.</li></ul>The student wants to explain why sealed honey never spoils. Which choice most effectively uses relevant information from the notes to accomplish this goal?",
      choices:{
        A:'Honey is a sweet food made by bees.',
        B:'Many people enjoy honey in tea or on bread.',
        C:'Honey is very low in water and very acidic, so bacteria cannot grow in it, which keeps sealed honey from spoiling.',
    ...
    },
    {
      ...
      skill:'Rhetorical Synthesis',
      passage:"",
      stem:"While researching a topic, a student has taken the following notes:<ul><li>A city added a new bike lane downtown.</li><li>Before the lane, about 200 people biked there each day.</li><li>After the lane, about 850 people biked there each day.</li><li>The lane is painted bright green.</li></ul>The student wants to emphasize how much bike use increased after the lane was added. Which choice most effectively uses relevant information from the notes to accomplish this goal?",
      choices:{
        A:'A city decided to add a new bike lane in its downtown area.',
        B:'After the bright green lane was added, daily bike use jumped from about 200 people to about 850.',
        C:'The new downtown bike lane is painted a bright green color.',
    ...
    },
    {
      ...
      skill:'Rhetorical Synthesis',
      passage:"",
      stem:"While researching a topic, a student has taken the following notes:<ul><li>Camels store fat in their humps.</li><li>The body can turn this fat into energy.</li><li>The fat can also be turned into water.</li><li>This helps camels go many days without drinking.</li></ul>The student wants to explain how humps help camels survive in the desert. Which choice most effectively uses relevant information from the notes to accomplish this goal?",
      choices:{
        A:'By storing fat that the body turns into energy and water, a camel’s hump helps it go many days without drinking.',
        B:'A camel’s hump is a well-known feature of the animal.',
        C:'Camels are large animals that live in deserts around the world.',
    ...
    },
    {
      ...
      skill:'Rhetorical Synthesis',
      passage:"",
      stem:"While researching a topic, a student has taken the following notes:<ul><li>Some plants are called \"pioneer species.\"</li><li>They are the first plants to grow on bare land.</li><li>For example, mosses often grow on bare rock.</li><li>Mosses help break the rock into soil.</li></ul>The student wants to give an example of a pioneer species. Which choice most effectively uses relevant information from the notes to accomplish this goal?",
      choices:{
        A:'Pioneer species are the first plants to grow on bare land.',
        B:'Bare land can be a difficult place for plants to grow.',
        C:'Some plants are known as "pioneer species."',
    ...
    },
    {
      ...
      skill:'Rhetorical Synthesis',
      passage:"",
      stem:"While researching a topic, a student has taken the following notes:<ul><li>Most bats sleep during the day.</li><li>They hunt for food at night.</li><li>Hummingbirds are active during the day.</li><li>They rest at night.</li></ul>The student wants to emphasize a contrast between when bats and hummingbirds are active. Which choice most effectively uses relevant information from the notes to accomplish this goal?",
      choices:{
        A:'Bats and hummingbirds are both interesting flying animals.',
        B:'Most bats sleep during the day and hunt for food at night.',
        C:'While bats hunt at night, hummingbirds are active during the day.',
    ...
    },
    {
      ...
      skill:'Rhetorical Synthesis',
      passage:"",
      stem:"While researching a topic, a student has taken the following notes:<ul><li>A student club collected old books for a school.</li><li>Their goal was to gather 500 books.</li><li>In the end, they collected 1,200 books.</li><li>The books filled three new library shelves.</li></ul>The student wants to state the main point of the notes. Which choice most effectively uses relevant information from the notes to accomplish this goal?",
      choices:{
        A:'The collected books filled three new library shelves.',
        B:'A student club decided to collect old books for a school.',
        C:'The club aimed to gather 500 books for the school.',
