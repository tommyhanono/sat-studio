...
(function(){
  window.SAT_SETS.push({
    ...
    questions: [
      {
        id:'VOCAB-01', type:'mc', domain:'Craft & Structure', difficulty:'Media',
      ...
      {
        id:'VOCAB-02', type:'mc', domain:'Craft & Structure', difficulty:'Media',
      ...
      {
        id:'VOCAB-03', type:'mc', domain:'Craft & Structure', difficulty:'Difícil',
        ...
        correct:'C',
        expCorrect:'"Praised...but" → mixed feelings. "Seemed to resent" → she acknowledged merit while witholding enthusiasm = grudging (unwilling, resentful acknowledgment).',
        expWrong:{
      ...
      {
        id:'VOCAB-04', type:'mc', domain:'Craft & Structure', difficulty:'Difícil',
      ...
      {
        id:'VOCAB-05', type:'mc', domain:'Craft & Structure', difficulty:'Media',
      ...
      {
        id:'VOCAB-06', type:'mc', domain:'Craft & Structure', difficulty:'Difícil',
      ...
      {
        id:'VOCAB-07', type:'mc', domain:'Craft & Structure', difficulty:'Hard',
        skill:'Nuanced meaning (similar-sounding words)',
        stem:'Which choice completes the text with the most logical and precise word or phrase?\n\n"The museum\'s collection was deliberately %BLANK%, with only essential pieces on display to focus visitors\' attention on the most significant works."\n',
        choices:{A:'sparse', B:'limited', C:'curated', D:'austere'},
        correct:'C',
        expCorrect:'"Essential pieces" and "focused attention" suggest intentional selection = curated (carefully selected and presented).',
        expWrong:{
          A:'Sparse = thinly distributed; doesn\'t emphasize intentional selection.',
          B:'Limited = restricted in quantity; lacks the sense of thoughtful curation.',
          D:'Austere = stark and bare; implies severity, not intentional focus.'
        },
      ...
      {
        id:'VOCAB-08', type:'mc', domain:'Craft & Structure', difficulty:'Media',
      ...
      {
        id:'VOCAB-09', type:'mc', domain:'Craft & Structure', difficulty:'Difícil',
        skill:'Distinguishing between similar negative words',
        stem:'Which choice completes the text with the most logical and precise word or phrase?\n\n"Critics found the novel\'s central character %BLANK%: while intended to be complex, she instead came across as internally inconsistent and unrealistic."\n',
        choices:{A:'unconvincing', B:'unlikeable', C:'incoherent', D:'underdeveloped'},
        correct:'C',
        expCorrect:'"Internally inconsistent" → the character lacks logical unity = incoherent.',
        expWrong:{
          A:'Unconvincing = not believable, but doesn\'t capture the specific flaw of inconsistency.',
      ...
      {
        id:'VOCAB-10', type:'mc', domain:'Craft & Structure', difficulty:'Hard',
      ...
      {
        id:'VOCAB-11', type:'mc', domain:'Craft & Structure', difficulty:'Hard',
      ...
      {
        id:'VOCAB-12', type:'mc', domain:'Craft & Structure', difficulty:'Hard',
