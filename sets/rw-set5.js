...
window.SAT_SETS.push({
  ...
  questions: [
    {
      id:'TRN-01', type:'mc', domain:'Expression of Ideas', difficulty:'Media',
      skill:'Transitions',
      passage:"For years, the small bakery threw away the crusty ends of every loaf it sliced. %BLANK% the owner began drying those ends and grinding them into a seasoned breadcrumb that she now sells in jars near the register.",
    ...
    },
    {
      ...
      skill:'Transitions',
      passage:"Heavy rainfall soaked the steep mountain slope above the town for three straight days, saturating ground that is normally dry and firmly packed. %BLANK% the loosened soil slid downhill in a single afternoon and buried a long stretch of the coastal highway by the weekend.",
      stem:'Which choice completes the text with the most logical transition?',
    ...
    },
    {
      ...
      skill:'Transitions',
      passage:"Most species of owl hunt after dark, relying on extraordinarily sharp hearing to pinpoint prey they can barely see in the gloom. %BLANK% the northern pygmy owl is active during broad daylight and hunts largely by sight, chasing small birds through sunlit forest clearings.",
      stem:'Which choice completes the text with the most logical transition?',
    ...
    },
    {
      ...
      skill:'Transitions',
      passage:"Public libraries today lend their communities far more than books, quietly expanding into a kind of shared warehouse of useful objects. %BLANK% many branches now offer patrons power tools, backyard telescopes, board games, cake pans, and even musical instruments to borrow for free with an ordinary library card.",
      stem:'Which choice completes the text with the most logical transition?',
    ...
    },
    {
      ...
      skill:'Transitions',
      passage:"Hoping to win over riders who had never tried it, the city's new bike-share program lowered its daily rental fee last spring to less than the cost of a bus ticket. %BLANK% it added dozens of docking stations in outlying neighborhoods that had never had a single one before.",
      stem:'Which choice completes the text with the most logical transition?',
    ...
    },
    {
      ...
      skill:'Transitions',
      passage:"Critics predicted that the museum's decision to charge no admission at all would cheapen its reputation and empty its galleries of serious visitors. %BLANK% attendance rose sharply in the months that followed, and visitor surveys showed that guests were spending far longer with each exhibit than before.",
      stem:'Which choice completes the text with the most logical transition?',
    ...
    },
    {
      ...
      skill:'Transitions',
      passage:"A honeybee returning to the hive performs a looping \"waggle dance\" on the comb. %BLANK% it communicates to the other bees both the direction of a food source and how far away it lies.",
      stem:'Which choice completes the text with the most logical transition?',
    ...
    },
    {
      ...
      skill:'Transitions',
      passage:"Solar panels generate no electricity at all once the sun sets, leaving homes that rely on them dependent on the wider power grid throughout the night. %BLANK% wind turbines often spin fastest after dark, when the cooler evening breezes over open plains tend to pick up rather than fade.",
      stem:'Which choice completes the text with the most logical transition?',
    ...
    },
    {
      ...
      skill:'Transitions',
      passage:"The volcano's constant tremors made it too dangerous for scientists to place sensors on the summit by hand. %BLANK% the research team flew in small drones to drop the equipment into position from the air.",
      stem:'Which choice completes the text with the most logical transition?',
    ...
    },
    {
      ...
      skill:'Transitions',
      passage:"Some readers assume that a great novel's first draft must arrive on the page fully formed, as if genius flowed effortlessly in a single sitting. %BLANK% the writer Toni Morrison revised her manuscripts repeatedly, reshaping whole chapters and characters long after the initial version was complete.",
      stem:'Which choice completes the text with the most logical transition?',
