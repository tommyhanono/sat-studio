...
window.SAT_SETS.push({
  ...
  questions: [
    {
      id:'RDG-01', type:'mc', domain:'Information and Ideas', difficulty:'Media',
    ...
    },
    {
      ...
      skill:'Inferences',
      passage:"In a study of urban trees, researchers found that streets lined with mature trees stayed several degrees cooler on hot afternoons than nearby streets with no trees. The shaded pavement absorbed less heat, and pedestrians reported feeling more comfortable walking there. City planners took note of these findings as they redesigned neighborhoods.",
    ...
    },
    {
      ...
      skill:'Central Ideas and Details',
      passage:"When the printing press spread across Europe in the 1400s, books could suddenly be produced far faster and more cheaply than by hand-copying. Ideas that once reached only a handful of scholars now circulated among merchants, students, and townspeople. This wider access reshaped how quickly new discoveries and opinions could travel.",
      stem:'Which choice best states the main idea of the text?',
      choices:{
        A:'The printing press made books more beautiful than hand-copied manuscripts had been.',
        B:'Before the printing press, only scholars in Europe were able to read.',
        C:'The printing press greatly widened who could access ideas and how fast they spread.',
    ...
    },
    {
      ...
      skill:'Inferences',
      passage:"A curator preparing an exhibit of ancient coins noticed that some pieces were badly worn, their images almost smooth, while others looked crisp and detailed. The worn coins, she realized, had likely passed through countless hands in daily trade, whereas the sharp ones had probably been buried or stored soon after they were made.",
      stem:'Based on the text, which statement is the most reasonable inference?',
      choices:{
        A:'The sharpest coins in the exhibit were the most valuable ones ever minted.',
        B:'Ancient people preferred to bury their coins rather than spend them.',
        C:'A coin’s level of wear can suggest how much it was used in everyday trade.',
    ...
    },
    {
      ...
      skill:'Central Ideas and Details',
      passage:"Honeybees communicate the location of food through a movement known as the \"waggle dance.\" By repeating a figure-eight pattern on the honeycomb, a returning bee signals both the direction and the distance of a flower patch to its hivemates. The angle of the dance points the way, while its duration tells the others how far they must fly.",
      stem:'Which choice best describes the main purpose of the text?',
      choices:{
    ...
    },
    {
      ...
      skill:'Inferences',
      passage:"Deep in certain caves live fish that have no working eyes at all. Their ancestors, which lived in sunlit rivers, could see perfectly well. But over many generations in total darkness, where vision offered no advantage, the fish gradually lost their sight while developing a sharper sense of touch and vibration. In an environment without light,",
      stem:'Which choice most logically completes the text?',
      choices:{
