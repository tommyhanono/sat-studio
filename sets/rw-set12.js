/* SAT Studio question set — Reading & Writing: Rhetorical Synthesis (RHD-01 to RHD-10) */
window.SAT_SETS.push({
  ...
  questions: [
    {
      id:'RHD-01', type:'mc', domain:'Expression of Ideas', difficulty:'Difícil',
      skill:'Rhetorical Synthesis',
      passage:"",
      stem:"While researching a topic, a student has taken the following notes:<ul><li>Two teams measured the age of the same ancient volcanic ash layer in Kenya.</li><li>Team A used argon-argon dating, which measures decay of radioactive potassium.</li><li>Team B used uranium-lead dating on tiny zircon crystals in the ash.</li><li>Team A reported an age of 1.87 million years.</li><li>Team B reported an age of 1.86 million years.</li><li>The two ages agree to within 1%.</li></ul>The student wants to emphasize a difference in the methods the two teams used, not in their results. Which choice most effectively uses relevant information from the notes to accomplish this goal?",
      choices:{
    ...
    },
    {
      ...
      skill:'Rhetorical Synthesis',
      passage:"",
      stem:"While researching a topic, a student has taken the following notes:<ul><li>A company tested a new battery design in 200 electric buses.</li><li>The batteries kept 92% of their capacity after five years of use.</li><li>Standard batteries typically keep about 70% after five years.</li><li>The test buses all operated in one mild-climate city.</li><li>Performance in very hot or very cold climates was not measured.</li><li>The company plans further trials in other regions.</li></ul>The student wants to highlight a limitation of the study. Which choice most effectively uses relevant information from the notes to accomplish this goal?",
      choices:{
        A:'The new batteries kept 92% of their capacity after five years, compared with about 70% for standard batteries.',
        B:'Because the test buses all ran in one mild-climate city, the results may not hold in very hot or very cold regions.',
        C:'The company tested its new battery design in 200 electric buses over five years.',
    ...
    },
    {
      ...
      skill:'Rhetorical Synthesis',
      passage:"",
      stem:"While researching a topic, a student has taken the following notes:<ul><li>The Antikythera mechanism is an ancient Greek device recovered from a shipwreck.</li><li>It dates to roughly 100 BCE.</li><li>It contains at least 30 interlocking bronze gears.</li><li>It could predict the positions of the Sun and Moon and the timing of eclipses.</li><li>Gearing of comparable complexity does not reappear until medieval European clocks, over a thousand years later.</li></ul>The student wants to emphasize how unexpectedly advanced the mechanism was for its time. Which choice most effectively uses relevant information from the notes to accomplish this goal?",
      choices:{
        A:'The Antikythera mechanism, an ancient Greek device from around 100 BCE, was recovered from a shipwreck.',
        B:'With its bronze gears, the Antikythera mechanism could predict the positions of the Sun and Moon and the timing of eclipses.',
        C:'The Antikythera mechanism contains at least 30 interlocking bronze gears.',
    ...
    },
    {
      ...
      choices:{
        ...
        C:'Listeners described Orchestra Y’s tone as warmer and softer, while they called Orchestra X’s brighter and louder.',
